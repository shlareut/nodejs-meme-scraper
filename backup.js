...
async function fetchWebsiteTextContent() {
  // --> according to Karl I can use const var = await fetch() directly. Try it out!
...
async function extractImageUrls() {
  ...
  const imagesArray = []; // Thought => does it make sense to define this array outside of the async function?
